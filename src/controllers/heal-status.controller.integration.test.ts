...
const emptyReport = {
  ...
  appliedOptions: {
    ...
    sliverMinDominantSharedBoundaryRatio: 0.4,
    sliverMinSharedBoundaryDominanceRatio: 2,
    sliverMinAbsorptionTargetAreaRatio: 10,
    gapToleranceMeters: 0.075,
    minimumGapWidthMeters: 0.025,
    maxInferredGapWidthMeters: 50,
    maxGapWidthToSharedBoundaryRatio: 0.1,
    minGapSharedBoundaryRatio: 0.5,
    lineTopologyToleranceMeters: 0.025,
    maxInferredLineErrorMeters: 100,
    spikeBaseToleranceMeters: 0.025,
    strongRingSpikeMinLegToBaseRatio: 10,
